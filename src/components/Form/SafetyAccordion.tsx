...
const SafetyAccordion = () => {
  ...
  const { modals, openModal, closeModal } = useModalManager(['AddImmediateAction', 'AddRootCase', 'EditRootCause', 'PreventiveCorrectiveAction'] as const);
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="space-y-4">
              ...
              <div className="row">
                <div className="col-12">
                  <div className="actionWrapper ">
                    <button className="iconBtn green v2 " onClick={() => openModal('AddImmediateAction')}>
                      <span>Add Immediate Action</span>
                      <img
                        width="15"
                        height="15"
                        alt="icon"
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="u-icon">
                                ...
                                <button className="tableBtn v2" onClick={() => openModal('EditRootCause')}>
                                <span className="iconPrimary">
                                  <img
                                    width="15"
                                    height="15"
      ...
      <CustomModal
          isOpen={modals.AddImmediateAction} onClose={() => closeModal('AddImmediateAction')}
