                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        <th style={{ minWidth: "60px" }} >S no.</th>
                                                <th style={{ minWidth: "120px" }}>Moc AF No.</th>
                        <th className="small" style={{ minWidth: "150px" }}>Created By & Date</th>
                        <th style={{ minWidth: "90px" }}>Unit</th>
                    ...
                    <tbody>
                      {getPaginatedMocData() && getPaginatedMocData().length > 0 ? (
                        getPaginatedMocData().map((item: any , index: number) => (
                        <tr key={item?.mocAfNo}>
                          <td>{index + 1}</td>
                           <td>
