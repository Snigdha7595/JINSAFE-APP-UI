    ...
    <Formik
      ...
      onSubmit={(values) => {
        setPirData((prevPirData: any) => ({
          ...prevPirData,
          accordionIndex: 0,
          costInRupees: values.costInRupees,
          costOfIncident: values.costOfIncident,
        }));
        ...
        return (
          <form onSubmit={handleSubmit}>
            <div className="filters">
              ...
              {!readOnly && <button className="iconBtn green v2 ms-0" onClick={() => setIrAction && setIrAction(null)} type="submit">
                <span>Next</span>
              </button>}
            </div>
          </form>
