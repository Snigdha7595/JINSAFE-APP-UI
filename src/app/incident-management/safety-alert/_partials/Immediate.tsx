...
const Immediate = ({
  ...
  const transformToSAAction = (action: any) => ({
    ...
    units: action.units || pirData?.unitId || "",
  ...
  const addNewAction = () => {
    if (!immedAction || !immedDepartment?.label || !immedSection?.label || 
        !immedAssignedLineManager?.label || !immedTargetDate) return;
    ...
    const newAction = {
      ...
      departments: immedDepartment.value,
                      ...
                      <div className="btnWrapper">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            ...
                            if (
                              !immedAction ||
                              !immedDepartment?.label ||
                              !immedSection?.label ||
                              !immedAssignedLineManager?.label ||
                              !immedTargetDate
                            )
                              return;
                            const newAction = {
