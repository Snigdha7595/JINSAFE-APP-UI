...
const SoAction = ({
  ...
  const [soActionList, setSoActionList] = useState([]);
  const [soActionById, setSoActionById] = useState<any>({});
  ...
  const [actionId, setActionId] = useState("");
   ...
   const fetchSoActionList = async (filterValues) => {
    setSoActionList([]);
    try {
      const response = await serverRequest(
        filterValues,
        FETCH_SO+ "/get-so-actions",
      ...
      if (response?.actions?.length > 0) {
        setSoActionList(response?.actions)
      }
    } catch (error) {
      console.error("Error fetching Action of SOs:", error);
    }
  };
  useEffect(() => {fetchSoActionList(filterValues);}, []);

  const fetchSoAction = async (id) => {
    try {
      const response = await serverRequest(
        {},
        FETCH_SO+ `/get-so-action/${id}/`,
  ...
  const updateSoAction = async (id, payload) => {
    try {
      const response = await serverRequest(
        payload,
        FETCH_SO+ `/update-so-action/${id}/`,
      ...
      console.error("Error during updating SO action.:", error);
    }
  };
...
    }
  };
 const reassignSoAction = async (id, payload) => {
    try {
      const response = await serverRequest(
        payload,
        FETCH_SO+ `/reassign-so-action/${id}/`,
        CONSTANTS.REQUEST_PUT,
        true,
        true,
        token
      ...
      console.error("Error during Reassign SO action.:", error);
    }
  };
  const formik = useFormik<FormValues>({
    ...
    onSubmit: (values) => {
      ...
      updateSoAction(actionId, payload);
              ...
              <div className="col-12">
                <div className="admin-table d3 table-responsive noHover">
                  <table className="table">
                    ...
                    <tbody>
                      {(soActionList &&
                        soActionList.length > 0) ? (
                        soActionList.map((so: any) => (
                          <tr key={so.id}>
                            <td>{so?.siNo}</td>
                            <td>{so?.assignLinemanager}</td>
                            <td>{so?.targetdate}</td>
                            <td>{so?.status}</td>
                            <td>
                             {(so?.status === "Open" ||
                                  ...
                                  {so?.status !== "Completed" && (
                                    <>
                                      <button
                                        ...
                                        type="button"
                                        onClick={() => {
                                          setActionId(so?.actionId);
                                          fetchSoAction(so?.actionId);
                                        }}
                                      >
                                        <span>
                                          <img
  ...
  title={`Update Action ( SO No. - ${soActionById?.header?.siNo} )`}
>
  <div
    ...
    <div className="c-accordion__head">
      ...
      <div className="col-md-3">
          <InputField
            ...
            name="UnitPreview"
            placeholder=""
            value={soActionById?.header?.unit}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            placeholder=""
            value={soActionById?.header?.department}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            name="SectionPreview"
            placeholder=""
            value={soActionById?.header?.sections}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            name="SODatePreview"
            placeholder=""
            value={soActionById?.header?.siDate}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            placeholder=""
            value={soActionById?.header?.duration}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            placeholder=""
            value={soActionById?.header?.nameObserver}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
      ...
      <div className="form_grider d1 row">
        <div className="col-md-6">
          <InputField
            ...
            value={soActionById?.observation?.observationDetail}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            value={soActionById?.observation?.exactLocation}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
         ...
         <div className="col-md-3">
          <InputField
            ...
            value={soActionById?.observation?.riskPotentials}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
       ...
       <div className="col-md-3">
          <InputField
            ...
            placeholder=""
            label="Type"
            value={soActionById?.observation?.observationType}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
         ...
         <div className="col-md-3">
          <InputField
            ...
            placeholder=""
            label="Category"
            value={soActionById?.observation?.observationCategory}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            placeholder=""
            label="Sub-Category"
            value={soActionById?.observation?.observationSubcategory}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
        ...
        <div className="col-md-3">
          <InputField
            ...
            value={soActionById?.observation?.observationSubsubcategory}
            disabled={true}
            onBlur={() => {}}
            onChange={() => {}}
            />
              ...
              <div className="d-flex flex-wrap justify-content-end gap-0 pt-3 border-top mt-2">
                <Link href="#">
                  ...
                  if (!formik.values.unit && !formik.values.departments && !formik.values.sections && !formik.values.assignLinemanager) {
                   ...
                   reassignSoAction(actionId, payload);                  
                  }}
                  >
                    <img
                      width="20"
            ...
            <button
                ...
                type="button"
                 onClick={() => {
                   ...
                   fetchSoActionList(payloadFilter); 
