...
const IMAction = ({
  ...
  const [filterValues, setFilterValues] = useState({
    ...
    responsibleSection: null,
    status: ["Pending", "WIP", "Done"],
  });
  const [imActionList, setIMActionList] = useState([]);
  const [imActionById, setIMActionById] = useState<any>({});
 ...
 const statusOptions = [
  ...
  const [actionId, setActionId] = useState("");
   ...
   const fetchIMActionList = async (filterValues) => {
    setIMActionList([]);
    try {
      const response = await serverRequest(
        filterValues,
        HORIZONTAL_DEPLOYMENT+ "/get-actions",
      ...
      if (response?.actions?.length > 0) {
        setIMActionList(response?.actions)
      }
    } catch (error) {
      console.error("Error fetching Action of IMs:", error);
    }
  };
  useEffect(() => {fetchIMActionList(filterValues);}, []);

  const fetchIMAction = async (id) => {
    try {
      const response = await serverRequest(
        {},
        HORIZONTAL_DEPLOYMENT+ `/get-action/${id}/`,
  ...
  const updateIMAction = async (id, payload) => {
    try {
      const response = await serverRequest(
        payload,
        HORIZONTAL_DEPLOYMENT+ `/update-action/${id}/`,
      ...
      console.error("Error during updating IM action.:", error);
    }
  };
...
    }
 ...
 const reassignIMAction = async (id, payload) => {
    try {
      const response = await serverRequest(
        payload,
        HORIZONTAL_DEPLOYMENT+ `/reassign-action/${id}/`,
        CONSTANTS.REQUEST_PUT,
        true,
        true,
        token
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: (values) => {
      ...
      updateIMAction(actionId, payload);
              ...
              <div className="col-12">
                <div className="admin-table d3 table-responsive noHover">
                  <table className="table">
                    ...
                    <tbody>
                      {(imActionList &&
                        imActionList.length > 0) ? (
                        imActionList.map((im: any) => (
                          <tr key={im?.actionId}>
                            <td>{im?.siNo}</td>
                            <td>{im?.imSubmoduleName}</td>
                            <td>{im?.assignLinemanager}</td>
                            <td>{im?.targetdate}</td>
                            <td>{im?.status}</td>
                            <td>
                            {/* {(im?.status === "Pending" || im?.status === "WIP" || im?.status === "Done") && (
                              <div style={{ display: "flex", gap: "8px", alignItems: "center" , justifyContent: "center"}}>
                                <button
                                  className="tableBtn"
                                  type="button"
                                  onClick={() => {
                                  setActionId(im?.actionId);
                                  fetchIMAction(im?.actionId);
                                 }}
                                >
                                  <span>
                                    <img
 ...
 <CustomModal
    ...
    title={
      ...
      >
        <span>
          Update Action ( IM No. - {imActionById?.action?.siNo} )
        </span>
        {/* <button
          className="tableBtn"
          type="button"
          onClick={() => downloadFile(imActionById?.safetyAlert?.safetyAlertPdf)}
        >
          <span className="u-icon">
            <Image
              width={15}
    ...
    <div className="c-accordion d1 row py-1">
        ...
        <div className="col-md-2">
            <InputField
                ...
                name="UnitPreview"
                placeholder=""
                value={imActionById?.pir?.unitName}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                ...
                placeholder=""
                value={imActionById?.pir?.departmentName}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                ...
                onBlur={() => {}}
                onChange={() => {}}
                value={imActionById?.pir?.sectionName}
                disabled={true}
                />
            </div>
            <div className="col-md-2">
            <InputField
                type="text"
                label="Incident Date"
                name="IncidentDatePreview"
                placeholder=""
                value={imActionById?.pir?.incidentDate}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
           ...
           <InputField
                type="text"
                label="Incident Time"
                name="incidentTimePreview"
                placeholder=""
                value={imActionById?.pir?.incidentTime}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                ...
                placeholder=""
                label="Status"
                value={imActionById?.action?.status}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
        ...
        <div className="form_grider d1 row">
            ...
            <InputField
                type="text"
                name="IncidentClassificationPreview"
                placeholder=""
                label="incident Classification"
                value={imActionById?.pir?.incidentClassification}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                type="text"
                name="IncidentCategoryPreview"
                placeholder=""
                label="IncidentCategory"
                value={imActionById?.pir?.incidentCategory}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                ...
                value={imActionById?.pir?.exactLocation}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                type="text"
                name="InjuryHappenedPreview"
                placeholder=""
                label="Injury Happened"
                value={imActionById?.pir?.injuryHappened}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
           ...
           <div className="col-md-3">
            <InputField
                type="text"
                name="whatHappenedPreview"
                placeholder=""
                label="What Happened"
                value={imActionById?.pir?.whatHappened}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                type="text"
                name="preliminaryFindingsPreview"
                placeholder=""
                label="Preliminary Findings"
                value={imActionById?.pir?.preliminaryFindings}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                type="text"
                name="HipoCasePreview"
                placeholder=""
                label="Hypo Case"
                value={imActionById?.pir?.hipoCase}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
            ...
            <InputField
                type="text"
                name="processStepsPreview"
                placeholder=""
                label="ProcessSteps"
                value={imActionById?.pir?.processSteps}
                disabled={true}
                onBlur={() => {}}
                onChange={() => {}}
                />
        ...
        <div className="col-12">
            ...
            <Link href="#">
                <button type="button" className="iconBtn green w100 gap-2"
                    ...
                    reassignIMAction(actionId, payload);                  
                    }}
                >
                <img
                    width="20"
...
<CustomModal
    ...
    <>
        ...
        <div className="row py-2 form_grider d1">
            ...
            <SelectField
                label="Unit"
                value={formik.values.responsibleUnit ? unitOptions.find((u) => String(u.value) === String(formik.values.responsibleUnit))
                    : null
                }
                ...
                options={unitOptions}
                onChange={(value) => {
                formik.setFieldValue("responsibleUnit", value?.value);
                formik.setFieldValue("responsibleDepartment", null);
                formik.setFieldValue("responsibleSection", null);
                fetchDepartments(value?.value);
                }}
            />
            </div>
            <div className="col-md-3">
             <SelectField
                label="Department"
                value={
                    formik.values.responsibleDepartment
                    ? departmentOptions.find((u) => String(u.value) === String(formik.values.responsibleDepartment))
                    : null
                }
                ...
                options={departmentOptions}
                onChange={(value) => {
                formik.setFieldValue("responsibleDepartment", value?.value);
                formik.setFieldValue("responsibleSection", null);
                fetchSections(value?.value);
                }}
                onBlur={formik.handleBlur}
             ...
             <SelectField
                label="Section"
                value={
                    formik.values.responsibleSection
                    ? sectionOptions.find((u) => String(u.value) === String(formik.values.responsibleSection))
                    : null
                }
                ...
                options={sectionOptions}
                onChange={(value) => {
                formik.setFieldValue("responsibleSection", value?.value);
                }}
                onBlur={formik.handleBlur}
             />
            </div>
            ...
            <button
                ...
                type="button"
                 onClick={() => {
                    ...
                    let payloadFilter = { 
                    pirId: formik.values.pirId || null,
                    fromDate: formik.values.fromDate || null,
                    toDate: formik.values.toDate || null,
                    assignedTo: user.createdBy,
                    responsibleUnit: formik.values.responsibleUnit || null,
                    responsibleDepartment:formik.values.responsibleDepartment || null,
                    responsibleSection: formik.values.responsibleSection || null,
                    status: Array.isArray(formik.values.statusFilter) &&
                      formik.values.statusFilter.length > 0
                        ? formik.values.statusFilter
                        : ["Pending", "WIP", "Done", "Completed"],
                     }
                   fetchIMActionList(payloadFilter); 
            ...
            <button
                ...
                type="button" onClick={() => { formik.resetForm(); fetchIMActionList(filterValues);}}>
                <span>Reset</span>
            </button>
            </div>
        </div>
