              ...
              <tr>
                ...
                >
                  ...
                  <span style={{ color: "black", fontWeight: 400 }}>
                    {!(["Reverted", "Rejected", "Approved"].includes(fetchedData?.mocAfStatus ?? "")) && (
                      <a
                        href="#"
                        onClick={(e) => {
                          e.preventDefault();
            ...
            <tbody>
              {fetchedMocCheckList.sort((a, b) => a.headerShtCode.localeCompare(b.headerShtCode)).map((item, idx) => (
                ...
                >
                  ...
                  <td style={{ padding: "11px" }}>
                    <button
                      onClick={() => router.push(`${APP_URL.HOD_CHECKLIST_VIEW}?checkList=${item?.headerShtCode}`)}
                      className="btn"
                      style={{
